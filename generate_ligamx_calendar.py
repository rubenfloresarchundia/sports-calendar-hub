...
def is_america_home_match(
    espn_event,
):
    home_team, _ = get_competitors(
        espn_event
    )

    return is_america_team(
        home_team
    )
